...
class TestSearchResults:
    ...
    def test_from_chroma_empty(self):
        ...
        chroma_data = {"documents": [[]], "metadatas": [[]], "distances": [[]]}
    ...
    def test_from_chroma_none_data(self):
        ...
        chroma_data = {"documents": None, "metadatas": None, "distances": None}
...
class TestVectorStore:
    ...
    def setup_vector_store(self):
        ...
        with (
            ...
            self.vector_store = VectorStore(
                chroma_path=self.temp_dir, embedding_model="test-model", max_results=5
            )
    ...
    def test_search_successful_no_filters(self):
        ...
        self.mock_content.query.assert_called_once_with(
            query_texts=["machine learning"], n_results=5, where=None
        )
    ...
    def test_search_course_name_not_found(self):
        ...
        results = self.vector_store.search(
            "variables", course_name="Nonexistent Course"
        )
    ...
    def test_search_with_lesson_number(self):
        ...
        self.mock_content.query.assert_called_once_with(
            query_texts=["concepts"], n_results=5, where={"lesson_number": 3}
        )
    ...
    def test_search_with_both_filters(self):
        ...
        self.mock_content.query.assert_called_once_with(
            query_texts=["topic"],
            n_results=5,
            where={"$and": [{"course_title": "Resolved Course"}, {"lesson_number": 2}]},
        )
    ...
    def test_search_custom_limit(self):
        ...
        self.mock_content.query.assert_called_once_with(
            query_texts=["query"], n_results=2, where=None
        )
    ...
    def test_resolve_course_name_successful(self):
        ...
        self.mock_catalog.query.assert_called_once_with(
            query_texts=["partial"], n_results=1
        )
