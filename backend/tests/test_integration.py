...
class TestRAGSystemIntegration:
    ...
    def test_query_successful_content_search(self):
        ...
        mock_response.content = [
            Mock(type="text", text="Based on the course materials, machine learning...")
        ]
        ...
        # Execute query
        answer, sources = self.rag_system.query(
            "What is machine learning?", "test_session"
        )
    ...
    def test_query_with_tool_execution(self):
        ...
        final_response.content = [
            Mock(type="text", text="Neural networks are computational models...")
        ]
        ...
        print(
            f"Vector store search call count: {self.rag_system.vector_store.search.call_count}"
        )
        print(
            f"AI generator call count: {self.rag_system.ai_generator.client.messages.create.call_count}"
        )
    ...
    def test_query_search_tool_error(self):
        ...
        final_response.content = [
            Mock(
                type="text", text="I apologize, but I encountered an error searching..."
            )
        ]
        final_response.stop_reason = "end_turn"
    ...
    def test_query_no_results_found(self):
        ...
        final_response.content = [
            Mock(
                type="text",
                text="I couldn't find relevant information about quantum computing...",
            )
        ]
        final_response.stop_reason = "end_turn"
    ...
    def test_query_with_conversation_history(self):
        ...
        mock_response = Mock()
        mock_response.content = [
            Mock(type="text", text="Based on our previous discussion...")
        ]
        mock_response.stop_reason = "end_turn"
        self.rag_system.ai_generator.client.messages.create.return_value = mock_response
        ...
        try:
            ...
            with patch.object(
                ...
                with patch("builtins.print") as mock_print:
                    ...
                    assert any(
                        "Added new course: Course 2" in call for call in print_calls
                    )
    ...
    def test_add_course_folder_clear_existing(self):
        ...
        try:
            ...
            test_chunks = [
                CourseChunk(content="Content", course_title="New Course", chunk_index=0)
            ]
