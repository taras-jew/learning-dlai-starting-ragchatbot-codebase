...
class TestAIGenerator:
    ...
    def test_generate_response_with_conversation_history(self):
        ...
        mock_response = MockResponse(
            content=[
                MockContentBlock(
                    type="text", text="Based on our previous discussion..."
                )
            ],
            stop_reason="end_turn",
        )
    ...
    def test_generate_response_with_tools_no_tool_use(self):
        ...
        mock_response = MockResponse(
            content=[
                MockContentBlock(type="text", text="I can answer without using tools")
            ],
            stop_reason="end_turn",
        )
    ...
    def test_generate_response_with_tool_use(self):
        ...
        final_response = MockResponse(
            content=[
                MockContentBlock(
                    type="text",
                    text="Based on the search results, machine learning is...",
                )
            ],
            stop_reason="end_turn",
        )
        ...
        self.ai_gen.client.messages.create.side_effect = [
            initial_response,
            final_response,
        ]
    ...
    def test_handle_tool_execution_single_tool(self):
        ...
        result = self.ai_gen._handle_tool_execution(
    ...
    def test_tool_execution_error_handling(self):
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.return_value = (
            "Tool execution failed: Database unavailable"
        )
    ...
    def test_anthropic_api_error(self):
        ...
        self.ai_gen.client.messages.create.side_effect = Exception(
