...
- **get_course_outline**: Use for questions about course structure, lesson lists, course titles, course links, or complete course outlines
...
"""
    ...
    def generate_response(
        ...
        # Add tools if available (including empty list)
